        ...
        <meta name="twitter:image" content="http://hyakunin-isshu-wordle.herokuapp.com/img/thumbnail.png" />
        ...
        <script type="text/javascript" src="js/main.js?202202271503"></script>
            ...
            <div class="popup_overlay">
                ...
                <div id="popup-how-to-use-content" class="popup_content" style="width: 95%; max-width: 800px; height: 95%;">
                    <h1 style="text-align: center; margin-bottom: 8px;">遊び方</h1>
                        ...
                        <br>
                        <p><span class="under">一致判定はマスごとに独立</span>で行われるので、この場合、「り」が2, 4文字目以外に何個存在するかという情報はわかりません。(ただし「り」が2文字含まれる札は「きりぎりす」の他に存在しないので、結果的に「り」は1文字だけ含まれることになります)</p>
                        <br>
