...
<html lang="ja">
    <head>
        ...
        <link rel="stylesheet" href="style.css?202202081808" />
    ...
    <body onload="brython();">
        ...
        <div class="dot"></div><p style="padding:4px 0px; margin:1px 6px 1px 6px; line-height:21px;">制限時間は5分です。百人一首Wordleはその性質上、答えがすぐに絞れてしまうことが多いので、難易度調整のために制限時間を設けています。</p>
